	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www9.53kf.com/webCompany.php?kf_sign=DM4OTMTU2ME0MTEwNTc5ODQ2MzI0MDA0NzIxNDc0NzU=&arg=10147475&style=1&kflist=off&kf=001&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.o-j-o.cn%2Fojo_buyer.html&keyword=http%3A%2F%2Fwww.o-j-o.cn%2Fyjp&brief=&logo=&question=&uid=5b727a1913452e5d295c60925312414f";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'https://www9.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div operating=\"null\" class=\"Lelem\" maxwidth=\"400\" maxheight=\"400\" minwidth=\"100\" minheight=\"100\" style=\"    position: relative; z-index: 10000; cursor: default;\" id=\"acc_title\"><div operating=\" \" class=\"Lelem\" type=\"img\" style=\"display: block; cursor: default; position: absolute; top: 15px; left: 9px; z-index: 10001; width: 404px; height: 189px;\"><img style=\"width: 404px; height: 189px;\" src=\"https://www9.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_11.png\"></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 20px; left: 20px; z-index: 10002; width: 107px; height: 22px; color: rgb(51, 51, 51);\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 15.4px; line-height: 22px; color: rgb(51, 51, 51); font-family: 宋体; font-weight: bold;\">在线客服邀请</span></div><div class=\"Lelem\" type=\"img\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; top: 21px; left: 393px; z-index: 10003; width: 10px; height: 8px;\"><img style=\"width: 10px; height: 8px;\" src=\"https://www9.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_9.png\"></div><div class=\"Lelem\" type=\"img\" style=\"display: block; cursor: default; position: absolute; top: 41px; left: 13px; z-index: 10004; width: 134px; height: 145px;\"><img style=\"width: 134px; height: 145px;\" src=\"https://www9.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_11.png\"></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 74px; left: 181px; z-index: 10005; width: 177px; height: 17px;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;\">您好，感谢大家的支持！</span></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 100px; left: 181px; z-index: 10006; width: 178px; height: 17px;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;\">请问有什么可以帮您？</span></div><div class=\"Lelem\" type=\"img\" operating=\"KF\" style=\"display: block; cursor: pointer; position: absolute; top: 133px; left: 182px; z-index: 10007; width: 111px; height: 34px;\"><img style=\"width: 111px; height: 34px;\" src=\"https://www9.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_15.png\"></div><div operating=\"CLOSE\" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: pointer; position: absolute; top: 143px; left: 314px; z-index: 10008; width: 60px; height: 17px; color: rgb(0, 204, 255);\"><span iseditable=\"1\" style=\"vertical-align: top; font-family: 宋体; text-decoration: underline; font-size: 12px;\">下次再说</span></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 181px; left: 16px; z-index: 10009; width: 118px; height: 17px;\"><a operating=\"HYLINK|http://www.53kf.la/kf.html|_blank\" style=\"text-decoration: none; cursor: pointer; color: rgb(170, 170, 170);\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 10px; line-height: 17px; font-family: 宋体;\">这是什么工具？</span></a></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: pointer; position: absolute; top: 179px; left: 308px; z-index: 10010; width: 96px; height: 17px;\"><a operating=\"HYLINK|http://www.53kf.la/kf.html|_blank\" style=\"text-decoration: none; cursor: pointer; color: rgb(170, 170, 170);\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 10px; line-height: 17px; font-family: 宋体;\">Powered by 53KF</span></a></div></div>";
			var is_autoyqk				= "1";
			...
			var acc_reinvite			= "1";
			var acc_reauto				= "1";
			var acc_reauto_time	 = 6000;
			var acc_poptime			 = 6000;
		//	var acc_poptype			 = -1;
            var acc_zdfq                = "yes";
			var acc_freeze				= "off";
			var acc_chattype			= 3;
            ...
            var ivt_zdfq                = "no";
            var ivt_poptime             = 50000;//邀请框延迟弹出
            var ivt_reauto				= "1";
			var ivt_reauto_time	        = 50000;
            var ivt_pop_page		 = "0";
			var ivt_pop_pagenum	= 1000;
			var ivt_pop_total		= "0";
			...
			if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			    		...
			    		Inv.prototype = {
			    			...
			    			talk : function(){
			    				...
			    				if (zdfq_type == 3) {
			    					...
			    					var openurl = "https://www9.53kf.com/webCompany.php?kf_sign=DM4OTMTU2ME0MTEwNTc5ODQ2MzI0MDA0NzIxNDc0NzU=&arg=10147475&style=1&kflist=off&kf=001&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.o-j-o.cn%2Fojo_buyer.html&keyword=http%3A%2F%2Fwww.o-j-o.cn%2Fyjp&brief=&logo=&question=&uid=5b727a1913452e5d295c60925312414f&tfrom=2" + force_kf;
			    					onliner_zdfq=2;
				...
				if(1 == 1){
					btn_style1 = 'background: center center no-repeat;background-image: url(https://www9.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(https://www9.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www9.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(https://www9.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
				}else {
					btn_style1 = 'background: center center no-repeat;background-image: url(https://www9.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(https://www9.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www9.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(https://www9.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
				...
				if(mini_style_type==1){
					bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="width:auto;white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
										...
										'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(https://www9.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(https://www9.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
									'</div>';
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="https://www9.53kf.com/img/upload/10147475/mobile/temp/mobile_53kf_1522048939.png"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			function cgpic(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('https://www9.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
				}

			}
			function cgpic2(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('https://www9.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
				}
			}
			function cgpic3(t){
				document.querySelector('.mini_maxto').style.background="url('https://www9.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
			}
			function cgpic4(t){
				document.querySelector('.mini_maxto').style.background="url('https://www9.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
			}
			function cgpic5(t){
				document.querySelector('.mini_close').style.background="url('https://www9.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
			}
			function cgpic6(t){
				document.querySelector('.mini_close').style.background="url('https://www9.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
			}
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
					...
					t.style.backgroundImage = "url('https://www9.53kf.com/style/chat/minichat2/img/max.png')";
					t.setAttribute('max_min','min');
					t.title = t.getAttribute('mini_recover');
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('https://www9.53kf.com/style/chat/minichat2/img/header_bg2_1.png')";
				}
				else
				{
					...
					t.style.backgroundImage = "url('https://www9.53kf.com/style/chat/minichat2/img/min.png')";
				...
				}                   $53("mini_header_bg_div").style.backgroundImage = "url('https://www9.53kf.com/style/chat/minichat2/img/header_bg_1.png')";
			...
			{
				if(zdfq_switch == 'yes') {
					//document.cookie = "onliner_zdfq72147475="+onliner_zdfq;
					document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
				} else {
					document.cookie = "my_acc_reauto_time=null;path=/";
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72147475="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"https://www9.53kf.com/webCompany.php?kf_sign=DM4OTMTU2ME0MTEwNTc5ODQ2MzI0MDA0NzIxNDc0NzU=&arg=10147475&style=1&kflist=off&kf=001&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.o-j-o.cn%2Fojo_buyer.html&keyword=http%3A%2F%2Fwww.o-j-o.cn%2Fyjp&brief=&logo=&question=&uid=5b727a1913452e5d295c60925312414f&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www9.53kf.com/webCompany.php?kf_sign=DM4OTMTU2ME0MTEwNTc5ODQ2MzI0MDA0NzIxNDc0NzU=&arg=10147475&style=1&kflist=off&kf=001&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.o-j-o.cn%2Fojo_buyer.html&keyword=http%3A%2F%2Fwww.o-j-o.cn%2Fyjp&brief=&logo=&question=&uid=5b727a1913452e5d295c60925312414f&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72147475&style_id=106195397\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
									if(valst[1].toLowerCase().indexOf('biz') > -1){
										var qq = valst[1].replace('biz','');
										link_str = 'https://www9.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
									}else{
